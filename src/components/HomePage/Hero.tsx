...
const HomePageHero = () => {
    return (
        <section className="w-19/20 lg:w-9/10 max-w-7xl mx-auto min-h-[60vh] 2xl:min-h-[50vh] flex flex-col gap-6 lg:gap-10 items-center justify-center py-12 relative">
            <motion.h2 
                className="text-blue-pri font-semibold text-3xl md:text-4xl lg:text-6xl text-center w-9/10 max-w-2xl mx-auto "
                initial={{opacity: 0, y: 10, rotate: 5}}
                animate={{opacity: 1, y: 0, transition: {duration: 0.3}, rotate: 0}}
            > 
