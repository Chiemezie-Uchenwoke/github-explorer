...
const FeaturesCard = ({title, desc}: FeaturesCardProps) => {
    return (
        <article className="bg-primary py-8 lg:py-10 px-4 lg:px-6 flex flex-col gap-5 rounded-2xl select-none hover:scale-105 transition duration-300 ease-in-out">
